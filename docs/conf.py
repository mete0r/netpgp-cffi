...
project = u'netpgp-cffi'
copyright = u'2015-2018, mete0r'
author = u'mete0r'
description = u'netpgp cffi binding'
doc_title = project
...
version = '.'.join(netpgp_cffi.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = netpgp_cffi.__version__
